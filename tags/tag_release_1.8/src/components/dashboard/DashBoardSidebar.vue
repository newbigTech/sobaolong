<template>
  <div class="sidebar">
    <el-menu class="el-menu-vertical" @open="handleOpen" @close="handleClose" theme="dark" :default-openeds="openeds">
      ...
      <el-submenu index="1">
        <template slot="title"><i class="el-icon-star-on"></i>仪表盘</template>
        <el-menu-item-group>
          <router-link to="/dashboard"><el-menu-item index="1-1" v-if="roleCheck('/dashboard')">统计信息</el-menu-item></router-link>
        </el-menu-item-group>
      </el-submenu>
