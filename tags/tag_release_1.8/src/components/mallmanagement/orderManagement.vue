    ...
    <div class='content'>
        ...
        <div class="userlist">
            ...
            <el-table :data='tableData' stripe border style="width: 100%" :height="$store.state.tableHeight" type="selection" v-loading="loading">
                <el-table-column prop="orderDate" label="订单日期" width=""></el-table-column>
                <el-table-column prop="orderId"  label="编号" width=""></el-table-column>
                <el-table-column prop="buyer"  label="买家账号" width=""></el-table-column>
                <el-table-column prop="buyerName"  label="买家名称" width=""></el-table-column>
                <el-table-column prop="scaleBase" label="扣点基数（%）"></el-table-column>
                <el-table-column prop="saleDeductionRatio" label="卖家赠送比（%）"></el-table-column>
                <el-table-column prop="buyDeductionRatio" label="买家赠送比（%）"></el-table-column>
