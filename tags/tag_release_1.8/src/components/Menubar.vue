        ...
        <el-row type="flex">
          ...
          <el-col :span="19">
            <el-menu theme="dark" :default-active="activeIndex" class="menus" mode="horizontal" @select="handleSelect" :router="true">
                ...
                <el-menu-item index="/snatch/welcome" v-if="roleCheck('snatch')">积分夺宝</el-menu-item>
                ...
                <el-menu-item index="/mallmanagement/welcome" v-if="roleCheck('mallmanagement')">商城管理</el-menu-item>
            </el-menu>
          </el-col>
          <el-col :span="1">
