...
const log = r => require.ensure([], () => r(require('@/components/system/log')), 'group-system')
...
const MoneyState = r => require.ensure([], () => r(require('@/components/infosearch/MoneyState')), 'group-infosearch')
// 大学生计划
