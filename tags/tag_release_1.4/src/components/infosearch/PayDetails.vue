       ...
       <div class='search' @keyup.enter="onSearch()">
        ...
        <div class="userlist">
            <el-table :data="tableData"  stripe border style="width: 100%" :height="$store.state.tableHeight" type="selection" v-loading="loading">
                <el-table-column prop="sn" label="业务流水号"  width="170"></el-table-column>
                ...
                <el-table-column prop="merchant_phoneNumber" label="商家手机号" width="130"></el-table-column>
                 <el-table-column prop="deduct_type" label="商家扣点" width="130"></el-table-column>
                ...
                <el-table-column prop="createDate" label="交易时间" width="170"></el-table-column>
                <el-table-column prop="PayType" label="交易方式" width="170"></el-table-column>
            </el-table>
  ...
  export default {
    ...
    methods: {
      ...
      onSearch (page = 1) {
        ...
        this.$axios.get(SITEURL.PAY_SEARCH + '?first_time=' + this.formInline.fromDate + '&area=' + text + '&area_type=' + num + '&page=' + page + '&limit=14' + '&last_time=' + this.formInline.toDate).then(response => {
          this.loading = false
          this.show = true
