  ...
  <div id="agent-dashboard" class="content">
    ...
    <div class="statistic">
      <el-form label-position="left" inline class="demo-table-expand">
        <el-form-item label="总现金余额"><span>{{ cashBalance }}</span></el-form-item>
        <el-form-item label="总积分余额"><span>{{ pointBalance }}</span></el-form-item>
      </el-form>
    </div>
    <div class="statistic">
      <el-form label-position="left" inline class="demo-table-expand">
    ...
    methods: {
      ...
      onSearch () {
        ...
        if (this.formInline.fromDate === '' && this.formInline.toDate === '' && this.formInline.adLocation === '') {
          ...
          this.$axios.get(SITEURL.DASHBOARD_SEARCH + '?fromDate=' + this.formInline.fromDate + '&toDate=' + this.formInline.toDate + '&areaId=' + this.formInline.areaId)
            .then(response => {
              this.loading = false
              this.rechargeCount = response.data.data.rechargeCount
              this.rechargeSum = response.data.data.rechargeSum
