  ...
  export default {
    ...
    methods: {
      ...
      onSearch (page = 1) {
        ...
        this.$axios.get(SITEURL.TRAINING_SEARCH + '?page=' + page + '&limit=15' + '&first_time=' + this.formInline.fromDate + '&last_time=' + this.formInline.toDate + '&name=' + name + '&phone=' + phone + '&type=' + num + are + area + '&pay_type=1').then(response => {
          this.loading = false
          this.show = true
